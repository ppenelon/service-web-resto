...
//Fonction qui génère un code client pour le système de fidélité en fonction de son ID (ID max : tailleAlphabet * tailleAlphabet * tailleAlphabet * tailleAlphabet * tailleAlphabet)
...
exports.genererCodeClient = function(idClient){
    ...
    var chaineFinale = "";
    var lettre;
    //On calcule X (O-O-O-O-X)
    lettre = alphabet.charAt(idClient % alphabet.length);
    chaineFinale = lettre + chaineFinale;
    //On ajoute un chiffre aléatoire de 0 à 9 à l'endroit _ (O-O-O-O_O)
    chaineFinale = Math.round(Math.random() * 9) + chaineFinale;
    //On calcule X (O-O-O-X-O)
    lettre = alphabet.charAt(Math.floor(idClient / alphabet.length) % alphabet.length);
    chaineFinale = lettre + chaineFinale;
    //On ajoute un chiffre aléatoire de 0 à 9 à l'endroit _ (O-O-O_O-O)
    chaineFinale = Math.round(Math.random() * 9) + chaineFinale;
    //On calcule X (O-O-X-O-O)
    lettre = alphabet.charAt(Math.floor(idClient / (alphabet.length * alphabet.length)) % alphabet.length);
    chaineFinale = lettre + chaineFinale;
    //On ajoute un chiffre aléatoire de 0 à 9 à l'endroit _ (O-O_O-O-O)
    chaineFinale = Math.round(Math.random() * 9) + chaineFinale;
    //On calcule X (O-X-O-O-O)
    lettre = alphabet.charAt(Math.floor(idClient / (alphabet.length * alphabet.length * alphabet.length)) % alphabet.length);
    chaineFinale = lettre + chaineFinale;
    //On ajoute un chiffre aléatoire de 0 à 9 à l'endroit _ (O_O-O-O-O)
    chaineFinale = Math.round(Math.random() * 9) + chaineFinale;
    //On calcule X (X-O-O-O-O)
    lettre = alphabet.charAt(Math.floor(idClient / (alphabet.length * alphabet.length * alphabet.length * alphabet.length)) % alphabet.length);
    chaineFinale = lettre + chaineFinale;
